...
class VoyagerDatabaseController extends Controller
{
    public function index()
    {
        ...
        return TenantVoyager::view('tenant-voyager::tools.database.index')->with(compact('dataTypes', 'tables'));
    }
    ...
    public function create()
    {
        ...
        return TenantVoyager::view('tenant-voyager::tools.database.edit-add', compact('db'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
               ->route('tenant-voyager.database.index')
    ...
    protected function prepareDbManager($action, $table = '')
    {
        ...
        if ($action == 'update') {
            ...
            $db->formAction = route('tenant-voyager.database.update', $table);
        } else {
            ...
            $db->formAction = route('tenant-voyager.database.store');
        }
    ...
    public function show($table)
    {
        ...
        $model_name = TenantVoyager::model('DataType')->where('name', $table)->pluck('model_name')->first();
        if (isset($model_name)) {
