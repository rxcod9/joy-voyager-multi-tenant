...
@section('content')
    @include('tenant-voyager::menus.partial.notice')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('tenant-voyager.menus.item.destroy', ['menu' => $menu->id, 'id' => '__id']) }}"
                          id="delete_form"
                          method="POST">
                        {{ method_field("DELETE") }}
                        {{ csrf_field() }}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="" id="m_form" method="POST"
                      data-action-add="{{ route('tenant-voyager.menus.item.add', ['menu' => $menu->id]) }}"
                      data-action-update="{{ route('tenant-voyager.menus.item.update', ['menu' => $menu->id]) }}">
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            @include('tenant-voyager::multilingual.input-hidden', ['_field_name' => 'title', '_field_trans' => ''])
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.item_actions').on('click', '.delete', function (e) {
                ...
                $('#delete_form')[0].action = '{{ route('tenant-voyager.menus.item.destroy', ['menu' => $menu->id, 'id' => '__id']) }}'.replace('__id', id);
            ...
            $('.dd').on('change', function (e) {
                $.post('{{ route('tenant-voyager.menus.order_item',['menu' => $menu->id]) }}', {
