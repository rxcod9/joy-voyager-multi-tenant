...
<div id="coordinates-formfield">
    <coordinates
        inline-template
        ref="coordinates"
        api-key="{{ config('tenant-voyager.googlemaps.key') }}"
        :points='@json($dataTypeContent->getCoordinates() && count($dataTypeContent->getCoordinates()) ? $dataTypeContent->getCoordinates() : [[ 'lat' => config('tenant-voyager.googlemaps.center.lat'), 'lng' => config('tenant-voyager.googlemaps.center.lng') ]])'
        :show-autocomplete="{{ $showAutocomplete }}"
        :show-lat-lng="{{ $showLatLng }}"
        :zoom={{ config('tenant-voyager.googlemaps.zoom') }}
    >
        <div>
