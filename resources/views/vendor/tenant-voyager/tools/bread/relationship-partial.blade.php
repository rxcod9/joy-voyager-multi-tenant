...
<div class="row row-dd row-dd-relationship">
    ...
    <div class="col-md-12 voyager-relationship-details">
        <a href="{{ route('tenant-voyager.bread.delete_relationship', $relationship['id']) }}" class="delete_relationship"><i class="voyager-trash"></i> {{ __('voyager::database.relationship.delete') }}</a>
