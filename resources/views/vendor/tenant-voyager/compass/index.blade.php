...
@section('css')
    ...
    @include('tenant-voyager::compass.includes.styles')
        ...
        <div class="tab-content">
            <div id="resources" class="tab-pane fade in @if(empty($active_tab) || (isset($active_tab) && $active_tab == 'resources')){!! 'active' !!}@endif">
                ...
                <div class="collapsible">
                    ...
                    <div class="collapse-content collapse in" id="links">
                        <div class="row">
                            <div class="col-md-6">
                                <a href="https://voyager-docs.devdojo.com/" target="_blank" class="voyager-link" style="background-image:url('{{ tenant_voyager_asset('images/compass/documentation.jpg') }}')">
                            ...
                            <div class="col-md-6">
                                <a href="https://voyager.devdojo.com/" target="_blank" class="voyager-link" style="background-image:url('{{ tenant_voyager_asset('images/compass/voyager-home.jpg') }}')">
              ...
              <div class="collapsible">
                ...
                <div class="collapse-content collapse in" id="fonts">
                    ...
                    @include('tenant-voyager::compass.includes.fonts')
          ...
          <div id="commands" class="tab-pane fade in @if($active_tab == 'commands'){!! 'active' !!}@endif">
            ...
            <div id="command_lists">
                @include('tenant-voyager::compass.includes.commands')
            </div>
          ...
          <div id="logs" class="tab-pane fade in @if($active_tab == 'logs'){!! 'active' !!}@endif">
            <div class="row">
                ...
                @include('tenant-voyager::compass.includes.logs')
